...
import com.example.application.views.flashcards.FlashCardsView;
import com.example.application.views.home.HomeView;
import com.example.application.views.login.LoginView;
import com.example.application.views.modifyflashcards.ModifyFlashCardsView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        H1 appName = new H1("LearnPunjabi");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("ModifyFlashCards", "la la-columns", ModifyFlashCardsView.class), //

                new MenuItemInfo("FlashCards", "la la-file", FlashCardsView.class), //

                new MenuItemInfo("Checkout", "la la-credit-card", CheckoutView.class), //
